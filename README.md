...
## sql
<br>В этом проекте, исследовав внутренние данные приложения для чтения книг, я определила, что нужно учесть для создания нового приложения для чтения.
<br>В нем я потренировалась в написании запросов SQL в Python.
